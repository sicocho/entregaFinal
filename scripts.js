...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para mostrar u ocultar la descripción ampliada
    function toggleDescripcion(card, producto) {
        ...
        if (descripcion.style.display === "block") {
            ...
            // Mostrar solo la descripción del producto seleccionado
            descripcion.innerHTML = `
    ...
    formularioContacto.addEventListener("submit", (event) => {
        ...
        if (!nombre || !email || !mensaje) {
            ...
            event.preventDefault(); // Evitar el envío del formulario si faltan campos
        } else {
            console.log("Formulario enviado correctamente.");
        }
    });

    // Generar lista de productos en la consola
